    ...
    <nav className="absolute top-0 left-0 grid grid-cols-2 items-center w-full p-8">
        ...
        <div className="justify-self-end flex justify-items-end items-center">
            <form className="relative w-64">
                <input className="w-full bg-black border border-white rounded-md py-1 px-3 transition-all duration-300 ease-in-out opacity-0 hover:opacity-100 focus:opacity-100" 
                    type="text" 
                    placeholder="Titúlos, gente e gêneros" 
                />
                <button className="absolute right-2 py-1 px-1">
